	...
	<div class="row">
		<div
			...
			<a href="/"
				...
				<use xlink:href="#bootstrap"></use></svg> <span class="fs-4">Employee Department 
					</span>
			</a>
			<hr>
			<ul class="nav nav-pills flex-column mb-auto container-fluid">
				...
				<li><a href="Employee_Section.jsp" class="nav-link text-white"> <svg
							class="bi pe-none me-2" width="16" height="16">
						<use xlink:href="#speedometer2"></use></svg> Employee Section
				</a></li>
				<li><a href="Departments.jsp" class="nav-link text-white"> <svg
							class="bi pe-none me-2" width="16" height="16">
				...
				<li><a href="Manage_Admin" class="nav-link text-white"> <svg
							class="bi pe-none me-2" width="16" height="16">
