			...
			<div class="card-body">
				<nav class="navbar navbar-light bg-light">
					<div class="container-fluid">
						...
						<%
						HttpSession sess = request.getSession(false); // Use getSession(false) to prevent creating a new session
						String userEmail = (String) sess.getAttribute("email");
						String userName = (String) sess.getAttribute("firstName");
						%>
				...
				<div class="card p-3 col-6 mx-auto">
					<div class="paint-card">
						...
						<form action="../Apply_leave" method="post"
							...
							<input type="hidden" name="leaveCode" id="leaveCode"> <input
								type="hidden" name="id" value="<%=employeeId%>">
							...
							<div class="mb-3">
								<label for="exampleInputPassword1" class="form-label">Your
									Leave Type</label> <select name="leave_type" class="form-control"
							...
							<div class="mb-3">
								...
								<textarea name="longText" rows="4" class="form-control"></textarea>
							</div>
