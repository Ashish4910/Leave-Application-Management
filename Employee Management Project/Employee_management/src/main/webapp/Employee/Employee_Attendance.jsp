	...
	<div class="row">
		...
		<div class="container col-lg-9 bg-light mt-4 right-content">
					...
					<div class="container-fluid">
						...
						<div class="dropdown nav-item ">
							<a class="btn btn-success dropdown-toggle btn-lg  btn-wider "
								...
								aria-expanded="false"> Welcome, <%=userEmail%>!
							</a>
							<ul class="dropdown-menu">

								<li><a class="dropdown-item" href="../employeeLogout">Log-Out</a></li>
							</ul>
						</div>
					</div>
				</nav>
			...
			<div>
				...
				boolean status = calculate.getTheStatusOfEmployeePunchIN(employeeId);
				System.out.println(" Status of the PunchIN " + status + " " + employeeId);
						...
						<div class="row">
							<div class="col-3">
								<form action="../punchIN" method="post"
									onsubmit="generateUniqueCode();" id="myForm">
									...
									<!-- Submit button -->
									<button type="submit" id="butdisable"
										class="btn btn-primary dropdown-toggle btn-lg btn-wider"
										<%if (!status) {%> disabled <%}%>>Check IN</button>
								</form>
							</div>
							...
							<div class="col-9 d-flex justify-content-end">
								<form action="../punchOUT" method="post">
									...
									<!-- Submit button -->
									<button type="submit"
										class="btn btn-danger dropdown-toggle btn-lg btn-wider"
										<%if (status) {%> disabled <%}%>>Check OUT</button>
								</form>
							</div>
		...
		document.addEventListener('DOMContentLoaded',
				function() {
					...
					const recovered = document
							.getElementById('recovered-input');
					const totalDaysInput = document
							.getElementById('coronavirus-input');
