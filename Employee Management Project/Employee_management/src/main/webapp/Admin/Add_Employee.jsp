			...
			<div class="container mt-4">
				...
				<form action="../Add_Employee" method="post"
					...
					<div class="mb-3">
						...
						</select> <span id="departmentError" class="error-message"></span>
					</div>
					...
					<div class="mb-3">
						...
						<input type="date" class="form-control" name="dob"> <span
							id="dobError" class="error-message"></span>
					</div>
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" name="country"> <span
							id="countryError" class="error-message"></span>
					</div>

					<div class="mb-3">
						<label for="exampleInputPassword1" class="form-label">Address
						</label> <input type="text" class="form-control" name="address"> <span
							id="addressError" class="error-message"></span>
					</div>
					<div class="mb-3">
						<label for="exampleInputPassword1" class="form-label">City</label>
						<input type="text" class="form-control" name="city"> <span
							id="cityError" class="error-message"></span>
					</div>
