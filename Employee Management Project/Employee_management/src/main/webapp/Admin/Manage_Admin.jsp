			...
			<div class="card-body">
				<nav class="navbar navbar-light bg-light">
					<div class="container-fluid">
						<a class="navbar-brand" href="Add_Departments"><h4>Manage
								Admin Section</h4></a> <a class="navbar-brand" href="Leave_type">Manage
							Admin/Admin Page</a>
						...
						<tr>
							...
							<td>
								<form action="../ManageAdminDelete" method="post">
									...
									<a href="Edit_ManageAdmin.jsp?id=<%=rs.getString("id")%>"
