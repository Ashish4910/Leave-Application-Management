		...
		<div class="container col-lg-9 bg-light mt-4">
			...
			<form action="../AddManageAdmin" method="Post">
				<div class="mb-3">
					...
					<label for="department_name" class="form-label">Name </label> <input
						type="text" class="form-control"
						aria-describedby="departmenmtHelp" name="name" required>

				</div>
				<div class="mb-3">
					<label for="Shortform" class="form-label">UserName</label> <input
						type="test" class="form-control" name="UserName" required>
				</div>
				<div class="mb-3">
					<label for="code" class="form-label">Email</label> <input
